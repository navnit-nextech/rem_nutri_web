...
const Custinsta = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 256 256"
    className="w-10 h-10 text-[#024027] fill-current"
  >
...
const ContactForm = () => {
  ...
  return (
    ...
    <div className="w-full bg-fizeo-beige-bg py-16 md:py-24 mt-25">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  ">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              <h2 className="text-[26px] md:text-[40px] font-['Libre_Baskerville',serif] text-[#024027]">Let's talk</h2>
              <p className="text-[#024027] text-[20px] font-['DM_Sans', 'sans-serif'] leading-relaxed">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-5">
                <div className="w-16 h-16 rounded-full bg-[#024027] flex items-center justify-center">
                  <Custommsg />
                </div>
                <div>
                  <h3 className="text-[#024027] text-[24px] font-['Libre_Baskerville',serif]">Email us</h3>
                  <a href="mailto:info@fizeo.com" className="text-[#024027] text-[20px] font-['DM_Sans', 'sans-serif']">
                    info@fizeo.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="text-[#024027] text-[24px]  font-['Libre_Baskerville',serif]">Phone us</h3>
                  <span className="text-[#024027] text-[20px] font-['DM_Sans', 'sans-serif']">8450 9087</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="text-[#024027] text-[24px]  font-['Libre_Baskerville',serif]">Find us</h3>
                  <span className="text-[#024027] text-[20px] font-['DM_Sans', 'sans-serif']">123 Main Street, French, 56789, Townsville.</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-6 pt-6">
              <a href="#" className="w-10 h-10  flex items-center justify-center text-[#024027] ">
                <Custinsta />
              </a>
              <a href="#" className="w-10 h-10 flex items-center justify-center text-[#024027]">
                <Custfacebook />
          ...
          <div className="border border-[#ebe5da] bg-[#f4f1eb] px-16 py-20 rounded-2xl relative -ml-4 md:-ml-8">


            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div>
                  <Label htmlFor="firstName" className="font-['DM_Sans', 'sans-serif'] text-[16px] text-[#024027]  ">
                    First Name*
                  </Label>
                  <Input
                    id="firstName"
                    required
                    className="bg-white border border-transparent focus-visible:ring-0 focus-visible:border-[#024027] focus-visible:border-[0.5px] text-black"
                  />
                </div>

                <div>
                  <Label htmlFor="lastName" className="font-['DM_Sans', 'sans-serif'] text-[16px] text-[#024027]">
                    Last Name*
                  </Label>
                  <Input
                    id="lastName"
                    required
                    className="bg-white border-transparent focus-visible:ring-0 focus-visible:border-[#024027] focus-visible:border-[0.5px] text-black"
                  />
                </div>

                <div>
                  <Label htmlFor="email" className="font-['DM_Sans', 'sans-serif'] text-[16px] text-[#024027]">
                    Email*
                  </Label>
                  <Input
                    id="email"
                ...
                <div>
                  <Label htmlFor="service" className="font-['DM_Sans', 'sans-serif'] text-[16px] text-[#024027]">
                    Service*
                  </Label>
                  <Input
                    id="service"
                ...
                <div>
                  <Label htmlFor="message" className="font-['DM_Sans', 'sans-serif'] text-[16px] text-[#024027]">
                    Message
                  </Label>
                  <Input
                    id="message"
              ...
              <Button
                type="submit"
                className="w-full bg-[#76FB91] text-[#024027] font-bold py-3 text-base"
              >
                Submit
              </Button>
            </form>
