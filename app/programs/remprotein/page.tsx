...
const programSteps = [
  {
    ...
    subtitle: "Personalized protein needs evaluation",
    description: "Begin with a comprehensive evaluation of your current protein intake, body composition, and individual protein requirements to create a targeted plan for healthy weight gain.",
  },
  {
    number: "02",
    title: "Customized Protein Plan",
    subtitle: "Expert nutrition guidance",
    description: "Receive a personalized high-protein meal plan that incorporates quality protein sources throughout the day to support muscle growth and healthy weight gain.",
  },
  {
    number: "03",
            ...
            >
              <ScrollAnimation>
                <div className="flex flex-col items-start">
                  ...
                  >
                    <span className="text-[var(--text-color-light)] text-sm sm:text-base">Protein Optimization Program</span>
                  </motion.div>
                  ...
                  >
                    Rem <span className="text-[var(--text-color-light)]">Protein</span>
                  </motion.h1>
                  ...
                  >
                    Discover the power of protein-rich nutrition with personalized meal plans and expert guidance. Optimize your protein intake for better health, energy, and vitality.
                  </motion.p>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-[var(--text-color-plain)] font-semibold">Protein Power</div>
                        <div className="text-[var(--text-color-plain)]/70 text-sm">Build strength & mass</div>
                      </div>
                    </div>
                  </motion.div>
                </motion.div>
            ...
            <ScrollAnimation>
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-[var(--text-color-dark)]/10 transition-all duration-300 hover:shadow-xl hover:shadow-[var(--text-color-light)]/5 hover:border-[var(--text-color-light)]/20 hover:transform hover:scale-[1.02] h-[350px] flex flex-col">
                ...
                <div className="mt-6 flex items-center gap-2 text-[var(--text-color-dark)]/60 text-sm">
                  ...
                  <span>Focuses on quality protein sources and optimal timing</span>
                </div>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation delay={0.2}>
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-[var(--text-color-dark)]/10 transition-all duration-300 hover:shadow-xl hover:shadow-[var(--text-color-light)]/5 hover:border-[var(--text-color-light)]/20 hover:transform hover:scale-[1.02] h-[350px] flex flex-col">
                ...
                <div className="mt-6 flex items-center gap-2 text-[var(--text-color-dark)]/60 text-sm">
                  ...
                  <span>Focus on optimal protein intake and balanced nutrition</span>
                </div>
              </div>
            </ScrollAnimation>
          </div>
                ...
                <ScrollAnimation delay={0.6}>
                  <div className="relative mt-12">
                    ...
                    <div className="rounded-2xl overflow-hidden relative z-10">
                      <Image
                        src="https://plus.unsplash.com/premium_photo-1673052882002-c1c80835efb0?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <ScrollAnimation>
            <div className="relative bg-[var(--background-color-dark)] rounded-2xl p-10 sm:p-16 text-center overflow-hidden">
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                >
                  Optimize Your <span className="text-[var(--text-color-light)]">Protein</span> Intake
                </motion.h2>
                ...
                >
                  Take the first step towards better health with our expert protein nutrition guidance.
                </motion.p>
