  ...
  return (
    <footer className="w-full  bg-[var(--background-color-dark)] text-white py-12 text-[14px]">
        ...
        <div className="w-full grid grid-cols-2 gap-8 md:grid-cols-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className=" text-[var(--text-color-plain)] font-['DM_Sans', 'sans-serif'] text-[10px] md:text-sm">About</a></li>
              <li><a href="#" className=" text-[var(--text-color-plain)] font-['DM_Sans', 'sans-serif'] text-[10px] md:text-sm ">Services</a></li>
              <li><a href="#" className=" text-[var(--text-color-plain)] font-['DM_Sans', 'sans-serif'] text-[10px] md:text-sm ">Blog</a></li>
              <li><a href="#" className=" text-[var(--text-color-plain)] font-['DM_Sans', 'sans-serif'] text-[10px] md:text-sm">Contact</a></li>
            </ul>
          </div>
      ...
      <div className="pt-6 px-[10%] flex flex-col items-start text-left md:flex-row md:justify-between">
        {/* Copyright */}
        <div className="mb-4 text-[var(--text-color-plain)] font-['DM_Sans', 'sans-serif'] text-[10px] md:text-[12px]">
